...
Within AAP, a Brain Unit is not defined by a specific model architecture.

Instead, it is defined by its ability to continuously execute meaningful actions under a trusted runtime.
...
Rather than repeatedly solving identical problems, Brain Units continuously refine their runtime assets.
...
Instead, they require persistent AI systems that operate under clearly defined ownership, responsibility, trust, and governance.
